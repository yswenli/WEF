//------------------------------------------------------------------------------
// <auto-generated>
//     此代码由WEF数据库工具, Version=3.8.6.6, Culture=neutral, PublicKeyToken=null生成;时间 2019-12-18 15:10:52.916
...
namespace WEF.Models
{
    ...
    public partial class DBTicketOrderRepository : IRepository<DBTicketOrder>
    {
        ...
        /// </summary>
        public int Insert(DBTicketOrder obj)
        {
        ...
        /// <param name="obj">传进的实体</param>
        /// </summary>
        public int Update(DBTicketOrder obj)
        {
        ...
        /// <param name="obj">传进的实体</param>
        /// </summary>
        public int Delete(DBTicketOrder obj)
        {
        ...
        {
            var obj = Search().Where(b => b.C_id == C_id).First();
        ...
        /// </summary>
        public int Deletes(List<DBTicketOrder> objs)
        {
            return db.Delete<DBTicketOrder>(objs);
        }
        /// <summary>
        /// 执行sql语句
