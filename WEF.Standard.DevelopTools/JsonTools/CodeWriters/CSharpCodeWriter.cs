...
namespace WEF.Standard.DevelopTools.JsonTools.CodeWriters
{
    public class CSharpCodeWriter : ICodeWriter
    {
        ...
        public void WriteClass(IJsonClassGeneratorConfig config, TextWriter sw, JsonType type)
        {
            ...
            else if (config.UseNestedClasses && type.IsRoot)
            {
                sw.WriteLine("    }");
            }
            else if (!config.UseNestedClasses)
            {
                sw.WriteLine("    }");
            }
